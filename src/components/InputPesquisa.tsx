...
export function InputPesquisa({ setPets }: InputPesquisaProps) {
  ...
  return (
    <section className="flex max-w-5xl mx-auto mt-3">
      ...
      <button
        type="button"
        className="ms-3 mt-2 focus:outline-none text-white bg-[#67AFB3] hover:bg-[#7dbabd] focus:ring-4 focus:ring-[#7dbabd] font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-[#67AFB3] dark:hover:bg-[#7dbabd] dark:focus:ring-[#7dbabd]"
