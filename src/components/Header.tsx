      ...
      <div className="flex flex-col justify-between items-center mx-auto h-full">
        ...
        <div className="header_userInfo bg-[#67AFB3] w-full flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="mr-1 inline-flex items-center p-2 text-sm font-medium text-center text-white bg-transparent rounded-lg hover:bg-gray-300 dark:text-white focus:ring-gray-50 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                    type="button"
                  >
                    <svg
                      className="w-5 h-5"
